...
class Attendance:
    def __init__(self, root):
        ...
        #img 1
        img=Image.open(r"D:\Face Recognition\college_images\clg.jpg")
        ...
        img_left = Image.open(r"D:\Face Recognition\college_images\face-recognition.png")
        ...
        left_inside_frame.place(x=10,y=135,width=730,height=500)
        ...
        btn_frame.place(x=0,y=350,width=700,height=35)

        import_btn = Button(btn_frame, text="Import csv",command=self.importCsv,font=("times new roman",13,"bold"),bg="blue",fg="white",width=23)
        import_btn.grid(row=0,column=0)

        export_btn = Button(btn_frame, text="Export csv",command=self.exportCsv,font=("times new roman",13,"bold"),bg="blue",fg="white",width=23)
        export_btn.grid(row=0,column=1)

        reset_btn = Button(btn_frame,command=self.reset_data ,text="Reset",font=("times new roman",13,"bold"),bg="blue",fg="white",width=23)
