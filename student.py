...
class Student:
    def __init__(self,root):
        ...
        #Image 1
        img=Image.open(r"D:\Face Recognition\college_images\face-recognition.png")
        ...
        #Image 2
        img1=Image.open(r"D:\Face Recognition\college_images\smart-attendance.jpg")
        ...
        #Image 3
        img2=Image.open(r"D:\Face Recognition\college_images\clg.jpg")
        ...
        #background Image
        img3=Image.open(r"D:\Face Recognition\college_images\wp2551980.jpg")
        ...
        main_frame.place(x=20,y=50,width=1920,height=920)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=810,height=580)

        img_left=Image.open(r"D:\Face Recognition\college_images\AdobeStock_303989091.jpeg")
        img_left=img_left.resize((810,130),Image.ANTIALIAS)
        ...
        current_course_frame.place(x=5,y=135,width=810,height=200)  
        ...
        dep_combo["values"]=("Select Department","CSE","ECE","ISE","MECH","CIVIL")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)    


        #Course
        dep_label=Label(current_course_frame,text="Course",font=("times new roman",13,"bold"),bg="white")
        ...
        course_combo["values"]=("Select Course","AI","ML","DATA SCIENCE","ROBOTICS","IOT")
        ...
        class_student_frame.place(x=5,y=250,width=810,height=300)     
        ...
        btn_frame.place(x=0, y=210, width=800, height=35)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=19,font=("times new roman",13,"bold"), bg="blue", fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",command=self.update_data ,width=19,font=("times new roman",13,"bold"), bg="blue", fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data ,width=19,font=("times new roman",13,"bold"), bg="blue", fg="white")
        ...
        btn_frame1.place(x=0, y=245, width=800, height=35)

        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample", width=39,font=("times new roman",13,"bold"), bg="blue", fg="white")
        ...
        img_right=Image.open(r"D:\Face Recognition\college_images\student.jpg")
        img_right=img_right.resize((810,130),Image.ANTIALIAS)
    ...
    #============= Generate Dataset take photo smaple ================
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #============ LOAD PREDFEINED DATA ON FACE FRONTAL FROM OPEN CV =======
