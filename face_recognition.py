...
class Face_Recognition:
    def __init__(self,root):
        ...
        img_top=Image.open(r"D:\Face Recognition\college_images\face_detector1.jpg")
        ...
        #second image
        img_bottom=Image.open(r"D:\Face Recognition\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
        ...
        #button
        b1=Button(f_lbl,text="Face Regonition",cursor="hand2",command=self.face_recog,font=("times new roman",18,"bold"),bg="darkgreen",fg="white")
        b1.place(x=310,y=620,width=230,height=40)
